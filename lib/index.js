...
const initOpal = function (files, logger, config, emitter, fileList) {
    ...
    fileList.refresh = function() {
        console.log("brady refresh override!");
        console.log("dumping patterns");
        console.dir(this._patterns);
        console.log("patterns dumped");
    ...
    // TODO: What triggers the initial file list modified anyways?? the server initially does a refresh
...
const theEmitter = function() {
  console.log("bah!");
};

module.exports = {
    'framework:opal': ['factory', initOpal],
    'value:emitter' : theEmitter
};
