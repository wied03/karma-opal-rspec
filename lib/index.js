...
const initOpal = function (files, logger, config, emitter, fileList) {
    ...
    const fileListChangedHandler = handleFileChanged(config, logger, fileList);
    // initial load for dependencies, etc.
    // TODO: Once we see a file changed event, figure out what to supply for this
    fileListChangedHandler();
