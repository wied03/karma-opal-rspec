...
const setupFileListOverrides = require('./setupFileListOverrides')

const initOpal = function (files, logger, config, fileList, emitter) {
    ...
    setupFileListOverrides(config, logger, preLoads, sprocketsPreloads, [], fileList, rack, emitter)
...
initOpal.$inject = ['config.files', 'logger', 'config', 'fileList', 'emitter']
