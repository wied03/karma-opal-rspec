...
const initOpal = function (files, logger, config, fileList) {
    ...
    setupFileListOverrides(config, logger, preLoads, sprocketsPreloads, [], fileList, rack)
...
initOpal.$inject = ['config.files', 'logger', 'config', 'fileList']
