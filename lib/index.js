...
var initOpal = function (files, logger, config) {
    ...
    var stdioSetting = log.isLevelEnabled('debug') ? 'inherit' : 'ignore';
    var rack = spawn('bundle', ['exec', 'rackup', '-I', __dirname, `${__dirname}/rack_server.ru`], {
        stdio: stdioSetting,
        env: env
    });
    ...
    var stacktraceJsPath = require.resolve('stacktrace-js/dist/stacktrace-with-promises-and-json-polyfills.min');
