...
const setupFileListOverrides = function (config, logger, preLoads, sprocketsPreloads, postLoads, fileList) {
    ...
    const getTestData = (files, pattern, existingPatterns, existingMetadata) => {
        ...
        return fetchMetadata(files).then((newMetadata) => {
            ...
            console.log("new combinedMetadata within getTestData")
            console.dir(combinedMetadata)
        ...
        return getPreloadData()
            .then((preloadUpdates) => {
                ...
                return Promise.reduce(patterns, (updates, patternObject) => {
                    ...
                    return getTestData(files, patternObject, updates.patterns, updates.metadata)
                }, preloadUpdates)
            })
            .then((updates) => {
